...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2025 at 09:36 AM
...
(1, 'Aeron James', 'Garcia', 'C.', 134, 'Bongato East', 'Bayambang', 'Pangasinan', 'Region 1', 'Philippines', '2004-03-03', 21, '09302218766', 'aerongarcia033@gmail.com', 'Arcelia', 'Garcia', 'Watching', 'Eywon', 1, 3),
(2, 'Lucas', 'Martinez', 'A.', 789, 'Poblacion', 'Dagupan City', 'Pangasinan', 'Region 1', 'Philippines', '2000-06-10', 24, '09123456780', 'lucasmartinez@example.com', 'Carlos', 'Martinez', 'Football', 'Luke', 2, 2),
(3, 'Sophia', 'Santos', 'B.', 456, 'Cabaruan', 'Urdaneta City', 'Pangasinan', 'Region 1', 'Philippines', '2001-05-20', 23, '09234567891', 'sophiasantos@example.com', 'Maria', 'Santos', 'Drawing', 'Sophie', 3, 4),
(4, 'Samuel', 'Reyes', 'C.', 222, 'Pangascasan', 'Sual', 'Pangasinan', 'Region 1', 'Philippines', '2003-08-15', 21, '09345678902', 'samuelreyes@example.com', 'Jose', 'Reyes', 'Cycling', 'Sam', 1, 1),
(5, 'Emma', 'Garcia', 'D.', 123, 'Zone 3', 'San Carlos City', 'Pangasinan', 'Region 1', 'Philippines', '2003-11-30', 21, '09456789013', 'emmagarcia@example.com', 'Elena', 'Garcia', 'Dancing', 'Emmy', 2, 3);
